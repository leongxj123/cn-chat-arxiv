...
| Ref | Title | Summary |
| --- | --- | --- |
| [^1] | [MLTCP: Congestion Control for DNN Training](https://arxiv.org/abs/2402.09589) | MLTCP是一种用于加速共享GPU集群中的DNN训练作业的拥塞控制技术，通过在每个训练迭代发送的字节数进行缩放，使不同作业的流能够高效利用网络极大地加快训练作业的完成时间。 |

# 详细

[^1]: MLTCP:用于DNN训练的拥塞控制技术
