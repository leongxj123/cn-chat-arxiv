...
| Ref | Title | Summary |
| --- | --- | --- |
| [^1] | [GPU Cluster Scheduling for Network-Sensitive Deep Learning.](http://arxiv.org/abs/2401.16492) | 我们提出了一种GPU集群调度器，用于分布式深度学习任务，根据任务对通信网络延迟的敏感性进行GPU资源的邻近基础一致性。相比传统的调度方法，我们的调度器可以提供高达69％的端到端Makespan提升。 |
