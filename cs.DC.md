...
| Ref | Title | Summary |
| --- | --- | --- |
| [^1] | [A Survey on Graph Neural Network Acceleration: Algorithms, Systems, and Customized Hardware.](http://arxiv.org/abs/2306.14052) | 本文综述了如何加速图神经网络处理图结构数据的方法，包括智能算法、高效系统和自定义硬件等，提出了GNN加速的分类，并为未来的研究提供了方向。 |

# 详细

[^1]: 一项图神经网络加速的综述：算法、系统和自定义硬件
