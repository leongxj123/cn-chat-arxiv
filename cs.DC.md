...
| Ref | Title | Summary |
| --- | --- | --- |
| [^1] | [High Dimensional Distributed Gradient Descent with Arbitrary Number of Byzantine Attackers.](http://arxiv.org/abs/2307.13352) | 本文提出了一种适用于高维问题、在任意数量拜占庭攻击者下的新方法，核心是一种直接的高维半验证均值估计方法，具有极小极值统计率。 |

# 详细

[^1]: 高维分布式梯度下降算法在任意数量拜占庭攻击者下的研究
