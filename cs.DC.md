...
| Ref | Title | Summary |
| --- | --- | --- |
| [^1] | [PePNet: A Periodicity-Perceived Workload Prediction Network Supporting Rare Occurrence of Heavy Workload.](http://arxiv.org/abs/2308.01917) | PePNet是一种支持罕见重负载的工作负载预测网络，通过周期性感知机制和融合多尺度序列学习的能力提高了整体特别是重负载的准确性。 |

# 详细

[^1]: PePNet: 一种支持罕见重负载的周期性感知工作负载预测网络
