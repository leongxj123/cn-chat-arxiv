...
| Ref | Title | Summary |
| --- | --- | --- |
| [^1] | [Language Aligned Visual Representations Predict Human Behavior in Naturalistic Learning Tasks.](http://arxiv.org/abs/2306.09377) | 语言对齐的视觉表示方式比纯视觉表示方式更有效地预测人类在自然学习任务中的行为。 |

# 详细

[^1]: 对齐语言的视觉表示预测人类在自然学习任务中的行为
