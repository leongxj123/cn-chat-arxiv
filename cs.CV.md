...
| Ref | Title | Summary |
| --- | --- | --- |
| [^1] | [Training Convolutional Neural Networks with the Forward-Forward algorithm.](http://arxiv.org/abs/2312.14924) | 本文基于Forward-Forward算法将其应用于卷积神经网络（CNN）的训练，采用了新颖的空间扩展标签技术，在MNIST手写数字数据集上达到了99.16%的分类准确率。 |

# 详细

[^1]: 使用Forward-Forward算法训练卷积神经网络
