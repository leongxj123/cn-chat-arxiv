...
| Ref | Title | Summary |
| --- | --- | --- |
| [^1] | [Online Resource Allocation with Convex-set Machine-Learned Advice.](http://arxiv.org/abs/2306.12282) | 该论文提出了一个框架，使用凸集机器学习建议来增强在线资源分配决策。该算法类在一致比率和鲁棒比率之间平衡，并在实验中表现出优异的性能。 |
