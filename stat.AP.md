...
| Ref | Title | Summary |
| --- | --- | --- |
| [^1] | [Detecting Grouped Local Average Treatment Effects and Selecting True Instruments.](http://arxiv.org/abs/2207.04481) | 我们提出了一个两步骤的过程来识别具有相同局部平均处理效应的响应组，并且即使有一些工具违反了识别假设，也可以选择真正满足假设的工具。 |

# 详细

[^1]: 检测分组的局部平均处理效应并选择真正的工具
