...
| Ref | Title | Summary |
| --- | --- | --- |
| [^1] | [Equivalence of inequality indices: Three dimensions of impact revisited.](http://arxiv.org/abs/2304.07479) | 本文探讨了不平等是自然演化的结果和通过数学模型和迭代过程来量化不平等的方法。其中，冲击分布可以通过时间依赖性代理模型来准确建模并结合富者越富和纯粹偶然成分。 |
