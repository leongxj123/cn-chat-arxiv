...
| Ref | Title | Summary |
| --- | --- | --- |
| [^1] | [Adaptive Selection of the Optimal Strategy to Improve Precision and Power in Randomized Trials.](http://arxiv.org/abs/2210.17453) | 本研究提供了一种自适应预设方法，以选择在随机试验中调整哪些变量，以及以何种形式进行调整，从而最大化精度，同时保持Ⅰ类错误控制。 |

# 详细

[^1]: 自适应选择最优策略以提高随机试验的精度和功效
