...
| Ref | Title | Summary |
| --- | --- | --- |
| [^1] | [Developing a Multi-variate Prediction Model For COVID-19 From Crowd-sourced Respiratory Voice Data](https://arxiv.org/abs/2402.07619) | 本研究开发了一个深度学习模型，通过声音录制数据识别COVID-19。通过提取语音特征并采用不同的深度学习分类模型，HuBERT实现了86%的最高准确率。 |

# 详细

[^1]: 从众包呼吸声数据开发多变量COVID-19预测模型
