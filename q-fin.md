...
| Ref | Title | Summary |
| --- | --- | --- |
| [^1] | [Causal Discovery in Financial Markets: A Framework for Nonstationary Time-Series Data.](http://arxiv.org/abs/2312.17375) | 该论文提出了一个名为CD-NOTS的算法，用于在金融市场中发现不同资产和变量之间的因果关系。通过对比不同算法选择的性能，该研究给出了有效使用CD-NOTS的一般建议。该算法可以作为因子投资、投资组合多样化和对市场动态的理解的有价值工具。 |

# 详细

[^1]: 金融市场中的因果发现：非平稳时间序列数据的框架
