...
| Ref | Title | Summary |
| --- | --- | --- |
| [^1] | [Sentiment Analysis of Citations in Scientific Articles Using ChatGPT: Identifying Potential Biases and Conflicts of Interest](https://arxiv.org/abs/2404.01800) | 使用ChatGPT进行情感分析揭示了科学文章引用中的偏见和利益冲突，增强了科学文献评估的客观性和可靠性 |

# 详细

[^1]: 使用ChatGPT对科学文章引用进行情感分析：识别潜在偏见和利益冲突
