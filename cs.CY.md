...
| Ref | Title | Summary |
| --- | --- | --- |
| [^1] | [What Symptoms and How Long? An Interpretable AI Approach for Depression Detection in Social Media.](http://arxiv.org/abs/2305.13127) | 本论文介绍了一种使用可解释的人工智能方法在社交媒体中检测抑郁症的方法。该方法创新地检测和解释抑郁症状及其持续时间，并通过大规模数据集的实证分析表明优于其他方法，发现了新的未注意到的症状。 |

# 详细

[^1]: 什么症状以及持续多久？一种可解释的人工智能方法用于社交媒体中的抑郁症检测。
