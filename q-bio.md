...
| Ref | Title | Summary |
| --- | --- | --- |
| [^1] | [Multi-modal Gaussian Process Variational Autoencoders for Neural and Behavioral Data.](http://arxiv.org/abs/2310.03111) | 该论文介绍了一种多模态高斯过程变分自编码器（GP-VAEs）的方法，用于描述神经和行为数据之间的关系。该方法通过将高斯过程因子分析（GPFA）和深度神经网络相结合，能够提取不同实验模态的共享和独立潜变量，并且具有解释能力。 |

# 详细

[^1]: 多模态高斯过程变分自编码器用于神经和行为数据
