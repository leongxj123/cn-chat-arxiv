...
| Ref | Title | Summary |
| --- | --- | --- |
| [^1] | [Semantic Representation Learning of Scientific Literature based on Adaptive Feature and Graph Neural Network.](http://arxiv.org/abs/2311.00296) | 提出了一种基于自适应特征和图神经网络的科学文献语义表示学习方法，通过全局和局部考虑科学文献特征，并使用图注意机制对具有引用关系的特征进行加权求和，以更好地表达不同科学文献特征之间的关联。 |

# 详细

[^1]: 基于自适应特征与图神经网络的科学文献语义表示学习
