...
| Ref | Title | Summary |
| --- | --- | --- |
| [^1] | [A Short Survey of Viewing Large Language Models in Legal Aspect.](http://arxiv.org/abs/2303.09136) | 本文调查了大型语言模型在法律领域中的使用情况，讨论了它们应用于法律任务时所面临的法律问题，以及使用数据资源在法律领域中专门化LLMs的可能性。 |

# 详细

[^1]: 查看大型语言模型在法律方面的简要调查
