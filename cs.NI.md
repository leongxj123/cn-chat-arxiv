...
| Ref | Title | Summary |
| --- | --- | --- |
| [^1] | [Hybrid-Task Meta-Learning: A Graph Neural Network Approach for Scalable and Transferable Bandwidth Allocation.](http://arxiv.org/abs/2401.10253) | 本文提出了一种基于图神经网络的混合任务元学习算法，用于可扩展和可转移的带宽分配。通过引入GNN和HML算法，该方法在不同的通信场景下具有较好的性能和采样效率。 |

# 详细

[^1]: 混合任务元学习：一种用于可扩展和可转移带宽分配的图神经网络方法
