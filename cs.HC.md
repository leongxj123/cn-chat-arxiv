...
| Ref | Title | Summary |
| --- | --- | --- |
| [^1] | [Can Large Language Models Replace Economic Choice Prediction Labs?](https://arxiv.org/abs/2401.17435) | 该论文研究大型语言模型是否能够取代经济实验室进行选择预测，并通过相关实验证明了其可行性。 |

# 详细

[^1]: 大型语言模型能否取代经济选择预测实验室？
